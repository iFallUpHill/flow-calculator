...
export default function TitleLabels() {
    return (
      <div className="flex gap-1">
        <p className="text-xs mb-2 font-semibold inline-block py-1 px-2 rounded-full text-black transition-colors duration-150 bg-neutral-200 hover:bg-neutral-300 cursor-pointer">
