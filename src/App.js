...
function App() {
  ...
  return (
    <div className="flex bg-slate-50 max-w-screen-xl">
      ...
      <main>
        <div className="m-8">
          <SlimAlert title=" Use at your own risk and discretion." msg="Verify all generated Gcode from this tool before attempting to print it. You are responsible for any damage caused to your printer as a result of using Gcode generated by this tool. " />
          <InputForm />
        </div>
      </main>
    </div>
